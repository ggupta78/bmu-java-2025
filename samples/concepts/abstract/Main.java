public class Main {
  public static void main(String[] args) {
    ...
    myCar.displayInfo(); // Calls the Car's info method, which uses the parent's method
    ...
    city.displayInfo(); // Calls the Car's info method, which uses the parent's method
